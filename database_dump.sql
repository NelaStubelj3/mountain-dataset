...
--
-- Name: mountainhuts; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.mountainhuts (
    hut_id integer NOT NULL,
    hut_name character varying(255) NOT NULL,
...
ALTER TABLE public.mountainhuts OWNER TO postgres;

--
-- Name: mountainhuts_hutid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.mountainhuts_hutid_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.mountainhuts_hutid_seq OWNER TO postgres;

--
-- Name: mountainhuts_hutid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.mountainhuts_hutid_seq OWNED BY public.mountainhuts.hut_id;
...
--
-- Name: mountainhuts hut_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mountainhuts ALTER COLUMN hut_id SET DEFAULT nextval('public.mountainhuts_hutid_seq'::regclass);
...
--
-- Data for Name: mountainhuts; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.mountainhuts (hut_id, hut_name, address, capacity, mountain_id) FROM stdin;
5	Mandara hut	Kilimanjaro National Park	60	3
6	Horombo Hut	Kilimanjaro National Park	120	3
7	Charles Inglis Clark Memorial Hut	Ben Nevis	26	4
3	Domhutte SAC	Salome Keller 3928   Randa	9	2
8	Snaefellsskali Hut	Vatnajokull National Park	45	6
9	Mountain Hut Zavizan	Velebit	29	10
10	Mountain Hut Vosac	Biokovo	25	8
4	Edelweiss	Erich und Philippa Hischier und Short 3920 Zermatt	40	2
1	Refuge de Bellachat Mountain Hut	305 Route de Vers le Nant Chamonix	24	1
2	The Tete Rousse Refuge mountain hut	82 Rue du Mont Blanc Saint Gervais	72	1
\.
...
2	The Mont Blanc Tour, Segment 4	The Mont Blanc Tour crosses three countries in 170 km of discovery for a total of 10 days of satisfaction.\nThis route is a variant of Segment 4, starting from the Combal Refuge (1969m) and proceeding towards Lake Miage before returning to the trail and approaching Courmayeur. The route takes place with steep paths but beautiful views. Some sections of the trail are eroded, so caution is advised.	Moderate	13.4	560.0	1
...
--
-- Name: mountainhuts_hutid_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.mountainhuts_hutid_seq', 19, true);
...
--
-- Name: mountainhuts mountainhuts_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mountainhuts
    ADD CONSTRAINT mountainhuts_pkey PRIMARY KEY (hut_id);
...
--
-- Name: mountainhuts mountainhuts_mountainid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mountainhuts
    ADD CONSTRAINT mountainhuts_mountainid_fkey FOREIGN KEY (mountain_id) REFERENCES public.mountains(mountain_id);
